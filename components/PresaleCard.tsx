      ...
      <div className="relative z-10">
        <div className="flex justify-between items-center mb-6">
          ...
          <div className="bg-emerald-500/10 border border-emerald-500/20 px-3 py-1 rounded-full flex items-center gap-1.5">
            ...
            <span className="text-[8px] font-nebula font-black text-emerald-500 uppercase">Live</span>
          </div>
        </div>
        ...
        <div className="space-y-3 mb-6">
          <div className="bg-black/20 border border-white/10 rounded-[2rem] p-6 focus-within:border-indigo-500/50 transition-colors">
            <div className="flex justify-between mb-2">
              <span className="text-[8px] font-nebula font-black text-slate-500 uppercase tracking-widest">You Pay</span>
              <span className="text-[8px] font-nebula font-black text-slate-500 uppercase tracking-widest">Bal: 0.00</span>
            </div>
            <div className="flex justify-between items-center">
              ...
              />
              <button className="flex items-center gap-2.5 bg-slate-800/80 border border-white/10 rounded-xl px-4 py-2 hover:bg-slate-700 transition-colors">
                <div className="w-5 h-5 bg-blue-500 rounded-lg flex items-center justify-center text-white"><Coins size={10}/></div>
                <span className="text-[10px] font-nebula font-black text-white">{selectedAsset}</span>
          ...
          <div className="bg-black/20 border border-white/10 rounded-[2rem] p-6 focus-within:border-indigo-500/50 transition-colors">
            <div className="flex justify-between mb-2">
              <span className="text-[8px] font-nebula font-black text-slate-500 uppercase tracking-widest">You Receive</span>
            </div>
            <div className="flex justify-between items-center">
              <div className="text-xl font-nebula font-black text-white">{receiveAmount.toLocaleString()}</div>
        ...
        <div className="mb-6">
          <div className="flex justify-between items-center mb-2">
            ...
            <span className="text-[8px] font-nebula font-black text-white uppercase tracking-widest">78%</span>
          </div>
        ...
        {/* Buy Button */}
        <button className="w-full py-4 bg-white text-slate-950 rounded-[1.5rem] font-nebula font-black text-[10px] uppercase tracking-[0.3em] shadow-2xl hover:scale-105 active:scale-95 transition-all flex items-center justify-center gap-2">
        ...
        <div className="mt-6 flex justify-center gap-8">
          <div className="flex items-center gap-1.5">
            ...
            <span className="text-[7px] font-nebula font-black text-slate-500 uppercase tracking-widest">Audited Genesis</span>
          </div>
          <div className="flex items-center gap-1.5">
            <TrendingUp size={10} className="text-indigo-400" />
            <span className="text-[7px] font-nebula font-black text-slate-500 uppercase tracking-widest">Listing Q1 2025</span>
          </div>
        </div>
      </div>
    </div>
